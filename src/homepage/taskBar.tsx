...
function TaskBar() {
    ...
    return (
        <div ref={taskBarRef} className="shadow-lg backdrop-filter backdrop-blur-md bg-gray-800 border-white border-gray-200 flex flex-row justify-items-center p-5 items-center gap-10 w-full fixed top-0 z-10">
