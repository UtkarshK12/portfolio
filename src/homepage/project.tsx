...
export default function Project({title, detail, url}: ProjectProps) {
  return (
    <div className="flex flex-col min-h-[300px] max-h-[300px] rounded-lg overflow-hidden hover:shadow-xl hover:-translate-y-1 transition duration-300 ease-in-out relative z-0"> {/* Add relative positioning */}
